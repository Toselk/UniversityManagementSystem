...
public:
    ...
    int studCount = 0;
    Student();
    Student(string name, int id, string email,string password, int max_hours_allowed, set<string>finished_courses, vector<double> gradesfor_finished_courses, set<string>inprogress_courses, string academic_year , vector<string> checkprereq);
