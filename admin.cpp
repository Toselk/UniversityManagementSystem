...
//---------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------
void Admin::add_student(string name, int id, string password, int max_hours_allowed, set<string>finished_courses, vector<double> gradesfor_finished_courses, set<string>inprogress_courses, string academic_year) {
	...
	student.gradesfor_finished_courses = gradesfor_finished_courses;
	student.inprogress_courses = inprogress_courses;
...
void Admin::addcoursegrade(Student x) { //*
	...
	x.gradesfor_finished_courses.clear();
	...
	for (it = x.finished_courses.begin(); it != x.finished_courses.end(); it++) {
		...
		x.gradesfor_finished_courses.push_back(grade);
